...
export function QuickTaskCategorySettings() {
  ...
  useEffect(() => {
    ...
    const allCategories = [
      ...new Set([...standardCategories, ...customCategoryNames]),
    ];
  ...
  const toggleCategory = (category: string) => {
    ...
    if (
      category === defaultQuickTaskCategory &&
      !newQuickTaskCategories.includes(category)
    ) {
      updateSetting(
        'defaultQuickTaskCategory',
        newQuickTaskCategories[0] || 'work'
      );
    }
  };
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-600 mb-4">
          Choose which categories appear in the quick task entry panel and set
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              <p className="text-sm text-yellow-700">
                You need at least one category for quick task entry. 'Work' will
