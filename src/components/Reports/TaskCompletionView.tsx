...
export function TaskCompletionView({ data, isLoading = false }: TaskCompletionViewProps) {
  ...
  if (data.length === 0) {
    return (
      <div className="text-center py-10">
        <p className="text-lg text-gray-500">No task data available for the selected period.</p>
        <p className="text-sm text-gray-400 mt-2">Try changing your filters or adding more tasks.</p>
      </div>
    );
  }
    ...
    <div>
      ...
      <div className="bg-white p-4 border rounded-lg mb-6">
        <div className="text-center mb-6">
          <h3 className="text-lg font-medium text-gray-700">Overall Completion Rate</h3>
          <div className="flex justify-center items-center my-3">
            <div className="relative w-32 h-32">
              <svg className="w-full h-full" viewBox="0 0 36 36">
                ...
                />
                <text x="18" y="21" textAnchor="middle" fontSize="10" fill="#4F46E5" fontWeight="bold">
              ...
              {data.map((item) => (
                <div key={item.id} className="border rounded-lg p-4 text-left">
                  ...
                  <div className="mt-2 text-right">
                    <span className="text-lg font-bold text-indigo-600">{item.formattedValue}</span>
                  </div>
                </div>
              ))}
            </div>
