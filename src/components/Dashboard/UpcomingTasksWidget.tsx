            ...
            >
              <div className="flex items-center justify-between mb-1">
                <div className="flex items-center">
                  ...
                  <h3 className="ml-2 font-medium text-gray-800 line-clamp-1">{task.title}</h3>
                </div>
              ...
              <div className="flex items-center text-xs text-gray-500 mt-1">
                ...
                <span className="mr-3">{formatDueDate(new Date(task.due_date))}</span>
...
function getUpcomingTasks(tasks: any[]) {
  ...
  const upcomingTasks = tasks
    ...
    .filter(task => 
      isBefore(task.parsedDueDate, maxDate)
    )
