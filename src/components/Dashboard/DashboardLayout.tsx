  ...
  return (
    <div className="flex flex-col h-screen">
      ...
      <div className="flex flex-1 overflow-hidden">
        {/* Sidebar */}
        <aside className={`w-64 h-full bg-gray-50 border-r overflow-y-auto transition-all duration-400 ${sidebarCollapsed ? '-ml-64' : 'ml-0'}`}>
          <div className="p-4">
            <button 
            ...
            <nav className="space-y-2">
              <a href="#" className="block px-4 py-2 rounded hover:bg-gray-200 transition duration-250">Important Tasks</a>
              <a href="#" className="block px-4 py-2 rounded hover:bg-gray-200 transition duration-250">Weekly Report</a>
              <a href="#" className="block px-4 py-2 rounded hover:bg-gray-200 transition duration-250">Team Overview</a>
            </nav>
          </div>
        </aside>
