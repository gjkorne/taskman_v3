  ...
  return (
    <div className="bg-white rounded-lg shadow-card hover:shadow-card-hover transition-shadow duration-300 p-5">
      <div className="flex justify-between items-center mb-4">
        ...
        <button className="text-gray-500 hover:text-kw-navy transition duration-250">
          <svg
      ...
      <div className="mt-2 flex flex-col items-center">
        <div className="w-full flex justify-between mb-2">
          ...
          <span className="text-kw-navy-deep text-sm font-medium">
        ...
        <div className="w-full bg-gray-200 rounded-full h-2 mb-4">
          <div
            className="bg-kw-navy h-2 rounded-full"
        ...
        <div className="grid grid-cols-3 w-full mt-4 gap-2">
          <div className="bg-gray-50 p-3 rounded text-center">
            <span className="block text-xl font-bold text-kw-navy">
