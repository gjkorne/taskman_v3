 ...
 */
export function RecentTasksWidget({ title = "Recent Tasks", limit = 5 }: RecentTasksWidgetProps) {
    ...
    >
      <div className="space-y-1">
        ...
        {recentTasks && recentTasks.map((task) => (
          <div key={task.id} className="flex items-center border-b border-gray-100 py-1.5 last:border-0">
