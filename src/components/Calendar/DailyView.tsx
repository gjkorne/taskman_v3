            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-1">
                  ...
                  <span className="text-[10px] sm:text-xs truncate">{durationText}</span>
                </div>
              </div>
            );
          })
...
export function DailyView({ date }: DailyViewProps) {
  ...
  const [activeTimeRange, setActiveTimeRange] = useState<'all' | 'business' | 'evening'>('all');
      ...
      <div className="mb-4 space-y-3">
        <div className="flex items-center justify-between">
          <h2 className="text-sm sm:text-lg md:text-xl font-semibold text-gray-800 flex items-center">
            <span className={`flex-shrink-0 ${isSelectedDateToday ? 'text-blue-600' : ''}`}>
            ...
            {isSelectedDateToday && (
              <span className="ml-2 text-xs bg-blue-100 text-blue-700 px-2 py-0.5 rounded-full">Today</span>
            )}
          </h2>
          ...
          <div className="bg-blue-50 rounded-lg p-2 sm:p-3 text-xs sm:text-sm">
            ...
            <div className="grid grid-cols-2 gap-2 mt-2">
              <div className="bg-white rounded p-2 shadow-sm">
                <div className="text-[10px] sm:text-xs text-gray-500">Sessions</div>
                <div className="font-semibold">{count} sessions</div>
              </div>
              <div className="bg-white rounded p-2 shadow-sm">
                <div className="text-[10px] sm:text-xs text-gray-500">Total Time</div>
      ...
      <div>
        ...
        {isLoading ? (
          ...
          <div className="py-12 text-center">
            ...
            <p className="text-gray-500 mb-2">No time sessions recorded for this day.</p>
            <button 
              onClick={() => setIsTaskModalOpen(true)}
