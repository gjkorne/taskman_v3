 ...
 */
export class ProjectTransformer extends BaseDataTransformer<
  ProjectApiDto,
  ProjectModel
> {
  /**
  ...
  updateInputToApi(input: ProjectUpdateInput): UpdateProjectApiDto {
    ...
    if (input.defaultTaskStatus !== undefined)
      result.default_task_status = input.defaultTaskStatus;
    if (input.defaultTaskPriority !== undefined)
      result.default_task_priority = input.defaultTaskPriority;
