...
> {
   ...
   */
  protected createDtoToDomain(
    dto: ProjectCreateDTO
  ): Omit<OfflineProject, 'id'> {
  ...
  protected applyUpdateDto(
    ...
    if (dto.defaultTaskStatus !== undefined)
      updates.defaultTaskStatus = dto.defaultTaskStatus;
    if (dto.defaultTaskPriority !== undefined)
      updates.defaultTaskPriority = dto.defaultTaskPriority;
