...
/**
 * Utility to check for duplicate categories
 */
...
// Log that the utilities are loaded
console.log('Category cleanup utilities loaded in debug/run-category-cleanup.ts');
