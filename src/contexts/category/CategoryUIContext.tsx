...
export const { Provider: CategoryUIProvider, useUIContext: useCategoryUI } =
  createUIContext({
    ...
    actions: (_state, setState) => ({
      ...
      closeCategoryModal: () => {
        ...
        setTimeout(
          () => setState((s) => ({ ...s, selectedCategoryId: null })),
          300
        );
      },
      toggleSubcategoriesVisibility: () =>
        setState((s) => ({ ...s, showSubcategories: !s.showSubcategories })),
